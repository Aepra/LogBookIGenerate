...
export default async function HomePage() {
  ...
  const { totalLogbooks, totalDays, totalActivities, totalPhotos } = stats;
  ...
  return (
    <div className="max-w-[700px] mx-auto px-4 sm:px-6 py-4 sm:py-6">
      ...
      <div className="mb-5 sm:mb-6">
        ...
        <p className="text-[14px] text-[var(--text-secondary)] mt-0.5">Overview of all your logbooks and activities.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
        ...
        <section>
          <div className="flex items-center justify-between mb-3 px-0.5">
            ...
            <Link
              href="/logbook"
              className="text-[13px] text-[var(--accent-blue)] font-medium hover:opacity-80 transition-opacity"
            >
              See All
            </Link>
          </div>
          <div className="space-y-2">
            {recentLogbooks.length === 0 ? (
              <div className="ios-card p-8 text-center">
                <p className="text-[14px] text-[var(--text-secondary)]">No logbooks yet.</p>
                <Link
                  href="/logbook/new"
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">LogBook.ID</h1>
        <p className="text-gray-500 mb-6">
          Manage your logbooks with integrated Google Drive. Sign in to get started.
        </p>
        <a
